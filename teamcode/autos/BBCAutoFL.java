...
@Autonomous(name = "BBCAutoFL", group = "Drivetrain")
public class BBCAutoFL extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        waitForStart();
        robot.driveAuto(1, 0,0,0,2.65);
        robot.driveAuto(0,1,0,0,1);
        robot.driveAuto(1, 0,0,0,0.7);
